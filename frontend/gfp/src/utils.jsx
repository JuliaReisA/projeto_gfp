//Endereço do servidor API, alterar conforme necessário

import { MdRestaurant, MdSchool, MdHome, MdSportsSoccer, MdShoppingCart, MdDirectionsCar, MdPets, MdFavorite, MdFitnessCenter, MdWallet, Md4K } from "react-icons/md";

// export const enderecoServidor = 'http://192.168.0.237:3000';
export const enderecoServidor = 'http://192.168.0.212:3000';
